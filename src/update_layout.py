...
class UpdateLayout(tgo.LinearLayout):

    def callback(self, res, error):
        self.a.set_active(self.a.main)
    
    def on_back(self):
        self.a.c.toast("Cancelling package list update", True)
        if self.request.cancel():
            self.a.set_active(self.a.main)

    def set_pm(self, pm: PM):
        self.pm = pm
        self.request = pm.fetch()
    ...
    def __init__(self, a: PackageActivity):
        ...
        self.text = tgo.TextView(self.a, "Updating package list", self)
